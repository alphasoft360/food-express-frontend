        ...
        <View className="h-fit w-full bg-transparent justify-around items-center">
          ...
          >
            <View className="gap-y-2">
              ...
              >
                {t(
                  "Food Express Multivendor Rider uses your precise location while you use the app to show your current position and support pickup and delivery navigation.",
                )}
              </Text>
            </View>
