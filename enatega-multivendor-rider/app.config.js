...
module.exports = {
  expo: {
    name: 'Food Express Multivendor Rider',
    description:
      ...
      [
        'expo-location',
        {
          locationAlwaysAndWhenInUsePermission:
            'Food Express Multivendor Rider uses your precise location during active deliveries so customers and dispatchers can follow delivery progress even when the app is not in use.',
